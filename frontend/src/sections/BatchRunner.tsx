...
const SAMPLE_OLIST_BATCH: Array<{ id: string; name: string; context: PaymentContext }> = [
  {
    ...
    context: {
      ...
      failure_reason: 'transient_network_timeout',
  ...
  },
  {
    ...
    context: {
      ...
      failure_reason: 'card_reported_lost_or_stolen',
  ...
  },
  {
    ...
    context: {
      ...
      failure_reason: 'boleto_barcode_unpaid_deadline_approaching',
  ...
  },
  {
    ...
    context: {
      ...
      failure_reason: 'insufficient_funds_balance',
  ...
  },
  {
    ...
    context: {
      ...
      failure_reason: 'acquirer_processing_error',
  ...
  },
  {
    ...
    context: {
      ...
      failure_category: 'SOFT_DECLINE',
      failure_reason: 'card_processor_declined_retry_limit',
  ...
  },
  {
    ...
    context: {
      ...
      failure_category: 'CUSTOMER_ACTION_REQUIRED',
      failure_reason: '3ds_authentication_friction_otp_not_entered',
  ...
  },
  {
    ...
    context: {
      ...
      failure_category: 'GENERIC_DECLINE',
      failure_reason: 'voucher_authorization_expired',
